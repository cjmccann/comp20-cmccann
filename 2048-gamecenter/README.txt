...
6. In order to send the final score and grid to my web application I:  
 ...
 --To get the index to display the game, I had to convert the 2048 index.html file to jade, and then edit some of the jade to link correctly to the server methods, and to add an ordered list in the appropriate section of the web page
